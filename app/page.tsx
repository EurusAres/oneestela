...
export default function HomePage() {
  ...
  return (
    <PublicLayout>
      ...
      <section className="relative min-h-[400px] md:min-h-[500px] lg:min-h-[600px] bg-gray-900 text-white overflow-hidden">
        {/* Optimized background image with Next.js Image */}
        <div className="absolute inset-0">
          <Image
            src={content.heroImage || '/images/venue-interior.jpg'}
            alt="One Estela Place venue interior"
            fill
            priority
            quality={85}
            sizes="100vw"
          ...
          <div 
            className={`absolute inset-0 bg-gradient-to-br from-amber-800 to-amber-900 transition-opacity duration-500 ${
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 lg:py-20 text-center relative z-10">
          <h1 className="mb-4 md:mb-6 text-fluid-3xl md:text-fluid-4xl lg:text-fluid-5xl font-bold drop-shadow-lg text-white">{content.heroTitle}</h1>
          <p className="mb-6 md:mb-8 text-fluid-base md:text-fluid-lg lg:text-fluid-xl drop-shadow-md text-white max-w-2xl mx-auto">
      ...
      <section className="py-8 md:py-12 lg:py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 md:mb-12 text-center text-fluid-2xl md:text-fluid-3xl font-bold">Why Choose One Estela Place?</h2>
          <div className="grid gap-4 md:gap-6 lg:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-fluid-lg md:text-fluid-xl">Prime Location</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-fluid-sm">Located in the heart of the city with easy access and stunning views</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-fluid-lg md:text-fluid-xl">Flexible Capacity</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-fluid-lg md:text-fluid-xl">Easy Booking</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-fluid-sm">Simple online booking system with real-time availability</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle className="text-fluid-lg md:text-fluid-xl">5-Star Service</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-fluid-sm">Professional staff dedicated to making your event unforgettable</CardDescription>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section id="about" className="bg-gray-50 py-8 md:py-12 lg:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="mb-4 md:mb-6 text-fluid-2xl md:text-fluid-3xl font-bold">About One Estela Place</h2>
            <p className="mb-3 md:mb-4 text-fluid-sm md:text-fluid-base text-gray-600">
            ...
            <p className="mb-4 md:mb-6 text-fluid-sm md:text-fluid-base text-gray-600">
      ...
      {/* CTA Section with Optimized Background */}
      <section className="relative py-8 md:py-12 lg:py-16 bg-gray-900 text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/cta-background.png"
            alt="Elegant chandelier background"
            fill
            quality={75}
            sizes="100vw"
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="mb-3 md:mb-4 text-fluid-2xl md:text-fluid-3xl font-bold drop-shadow-lg text-white">
