  ...
  try {
    ...
    return NextResponse.json({
      summary: {
        ...
        totalRevenue: parseFloat(String(totals.total_revenue || '0')),
        totalUsers: userStats.total_users || 0,
        unreadMessages: msgStats.unread || 0,
        totalMessages: msgStats.total || 0,
        totalReviews: reviewStats.total_reviews || 0,
        avgRating: reviewStats.avg_rating ? parseFloat(String(reviewStats.avg_rating)).toFixed(1) : null,
        approvedReviews: reviewStats.approved_reviews || 0,
        featuredReviews: reviewStats.featured_reviews || 0,
      },
      thisMonth: {
        bookings: thisMonth.count || 0,
        revenue: parseFloat(String(thisMonth.revenue || '0')),
      },
      lastMonth: {
        bookings: lastMonth.count || 0,
        revenue: parseFloat(String(lastMonth.revenue || '0')),
      },
