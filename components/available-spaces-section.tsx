                ...
                <div className="h-48 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=800&h=600&fit=crop';
                    }}
                  />
                </div>
                <CardHeader>
              ...
              <Card key={`room-${room.id}`} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-48 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
                      target.src = 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop';
                    }}
                  />
                </div>
                <CardHeader>
